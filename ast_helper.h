...
enum NODE_TYPE {HTML, HEAD, TITLE, BODY, P, CENTER, H1, H2, H3, H4, H5, H6, DIV, U, BOLD, I, EM, TT, SMALL, SUB, SUP, BR, GREEK, A, 
                FONT, IMG, FIG, FIGC, TABLE, T_CAPTION, TR, TH, TD, UL, OL, LI, DL, DT, DD, COMMENT, data, multi, attributes};
